...
//		String appKey = "n19jmcy59nj69";//替换成您的appkey
//		String appSecret = "G3Iep6hIk4tLy";//替换成匹配上面key的secret
//
//		Reader reader = null ;
...
//
//		System.out.println(messagePublishPrivateResult.getCode()+"   "+messagePublishPrivateResult.getErrorMessage());
